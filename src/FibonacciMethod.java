...
public class FibonacciMethod extends AbstractSubject implements OptimizationMethod
{
  ...
  private static final long[] fib = {1L, 1L, 2L, 3L, 5L, 8L, 13L, 21L, 34L, 55L, 89L, 144L, 233L,
      377L, 610L, 987L, 1597L, 2584L, 4181L, 6765L, 10946L, 17711L, 28657L, 46368L, 75025L, 121393L,
